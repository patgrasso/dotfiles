...
values."
  ...
  (setq-default
   ...
   ;; Custom: If we're in a terminal environment, use the second set of
   ;; colors. If we're in a graphic environment, use the first set
   dotspacemacs-themes
...
you should place you code here."
  ...
  ;(require 'helm)
  ;(require 'helm-config)
  ;(define-key helm-map (kbd "C-[") 'keyboard-escape-quit)
  ;(define-key help-map (kbd "C-[") 'keyboard-escape-quit)
  (require 'flycheck)
  ...
  (setq-default markdown-command "Markdown.pl")
  ...
  (add-hook 'c++-mode-hook
      (lambda () (setq-default tab-width 4)))
